...
CN：
内容包含了对示例对象的本体结构拉取以及用Protege创建本体（Owl-Datei), 用户如果想要预览设备上需要提前下载Protege软件。
主要内容是对于本体也就是目标对象结构的可视化，主要使用的是Qt GUI等以及在可视化方向需要的工具包,使用的语言是Python.
项目结果是：用户可以对于目标对象的结构信息进行可视化的读取和使用.
为了更直观的看结果，可以直接打开文件：Screenshot
